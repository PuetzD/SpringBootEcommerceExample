...
class AuthenticatedCustomerIdentityTest {
    @Mock
    private AuthenticatedAccountIdentity authenticatedAccount;
    @Mock
    private CustomerReferenceQuery customerQuery;
    @InjectMocks
    private AuthenticatedCustomerIdentity currentCustomer;
    @Test
    void givenAuthenticatedAccountWithCustomer_returnsCustomerReference() {
        ...
        when(authenticatedAccount.account())
                .thenReturn(new AccountReference(accountId));
        ...
        assertThat(result)
                .isPresent()
                .contains(new CustomerReference(customerId));
