...
The decision to promote the shared identifiers into `sharedkernel` is **accepted** — see [ADR-0001](./docs/adr/0001-shared-kernel-identifiers-and-money.md). Administration's delivery-channel boundary is recorded in [ADR-0002](./docs/adr/0002-administration-as-catalog-delivery-channel.md).
